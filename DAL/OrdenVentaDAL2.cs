...
namespace DAL
{
    public class OrdenVentaDAL2 : AbstractDAL<OrdenVentaBE2>
    {

        //Bindea la lista de campos de un registro de una consulta, con un objeto BE.
        private OrdenVentaBE2 bindSchema(List<Object> fieldData)
        {
            if (fieldData.Count == 0)
                return null;

            //Armo un usuario que sera el cual se actualizara los campos.
            OrdenVentaBE2 ordenVenta = new OrdenVentaBE2();
        ...
        public OrdenVentaBE2 findById(long id)
        {
        ...
        public List<OrdenVentaBE2> findAll()
        {
            //Busco en la bd por id.
            List<object> result = this.getSelect().selectAll("orden_venta");

            //Lista resultado.
            List<OrdenVentaBE2> lista = new List<OrdenVentaBE2>();
        ...
        public List<OrdenVentaBE2> getLastActivities()
        {
        ...
        public List<OrdenVentaBE2> getLastActivitiesByMoney(MonedaBE moneda)
        {
            //Lista resultado.
            List<OrdenVentaBE2> lista = new List<OrdenVentaBE2>();
        ...
        public int save(OrdenVentaBE2 venta)
        {
        ...
        //Buscar por monedas
        public List<OrdenVentaBE2> searchByMoneys(MonedaBE ofrece, MonedaBE pide)
        {
        ...
        public List<OrdenVentaBE2> searchBySeller(ClienteBE seller)
        {
            //Busco en la bd por dni.
            List<Object> result = this.getSelect().selectAnd(new Dictionary<string, Object>{
